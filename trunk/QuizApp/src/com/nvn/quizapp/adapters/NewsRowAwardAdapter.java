...
import com.nvn.quizapp.adapters.NewsRowAdapter.ViewHolder;

public class NewsRowAwardAdapter extends ArrayAdapter<Exam> {
	private Activity activity;
	private List<Exam> items;
	private Exam objBean;
	private int row;

	public NewsRowAwardAdapter(Activity act, int resource, List<Exam> arrayList) {
