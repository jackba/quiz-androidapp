...
import com.nvn.quizapp.adapters.AwardsAdapter.ViewHolder;

public class AnswersAdapter extends ArrayAdapter<Exam> {
	private Activity activity;
	private List<Exam> items;
	private Exam objBean;
	private int row;

	public AnswersAdapter(Activity act, int resource, List<Exam> arrayList) {
